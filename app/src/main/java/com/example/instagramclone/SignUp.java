    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSignUp:
                ...
                if (edtEnterEmail.getText().toString().equals("") || edtUsername.getText().toString().equals("") || edtEnterPassword.getText().toString().equals("")) {
                    ...
                    appUser.signUpInBackground(new SignUpCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                ...
                                FancyToast.makeText(SignUp.this, " There was an error: " + e.getMessage(), Toast.LENGTH_LONG, FancyToast.ERROR, true).show();
                            }
